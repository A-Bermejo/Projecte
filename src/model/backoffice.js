...
exports.getAll = async function(recipe_id, user_id) {
    ...
    for (let i = 0; i < res.length; i++) {
        var ingredients = await pool.query("SELECT ingredients.nom_ingredient FROM ingredients_recepta " +
...
exports.add = async function(body, id, file) {
    ...
    var res = await pool.query("INSERT INTO " + TABLE_NAME + " " +
        ...
        "VALUES (?, ?, ?, ?, ?, ?,?) ", [body.nom_recepta, body.descripcio_recepta, body.pais, id, 1, tiempo, file])
