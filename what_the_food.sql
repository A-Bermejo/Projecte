...
(46, 'asdasdasd', 'sdaasdasdasd', 'img-1654524218410.png', 19, 1, 3, '13:13:00'),
(47, 'sdasd', 'zxcxzcz', 'img-1654524398294.png', 1, 1, 3, '12:02:00'),
(48, 'Lentejas ', 'sdadasdasd', 'img-1654525087851.png', 3, 1, 3, '01:01:00'),
(49, 'Lentejas ', 'sadasda', 'img-1654525156147.png', 1, 1, 3, '01:01:00'),
(50, 'Lentejas ', 'adsadasda', 'img-1654525428163.png', 1, 1, 3, '01:01:00'),
(51, 'Prueba', 'asdasdasd', NULL, 3, 1, 3, '01:01:00'),
(52, 'Prueba', 'asdasdasd', NULL, 3, 1, 3, '01:01:00'),
(53, 'Prueba', 'dsadasd', NULL, 3, 1, 3, '01:01:00'),
(54, 'Prueba', 'asdasd', NULL, 1, 1, 3, '01:01:00'),
(55, 'Prueba', 'asdasd', NULL, 1, 1, 3, '01:01:00'),
(56, 'adasd', 'q1', NULL, 3, 1, 3, '01:01:00'),
(57, 'adasd', 'q1', NULL, 3, 1, 3, '01:01:00'),
(58, 'Lentejas ', 'assdaad', NULL, 1, 1, 3, '01:01:00'),
(59, 'Lentejas ', 'assdaad', NULL, 1, 1, 3, '01:01:00'),
(60, 'Lentejas ', 'assdaad', NULL, 1, 1, 3, '01:01:00'),
(61, 'sdad', 'sadsad', NULL, 1, 1, 3, '01:01:00'),
(62, 'Prueba final', 'sdaas', NULL, 83, 1, 3, '01:01:00'),
(63, 'Prueba final', 'sdaas', NULL, 83, 1, 3, '01:01:00'),
(64, 'Lentejas 22', 'sadsad', 'img-1654880815517.png', 3, 1, 3, '01:01:00'),
(65, 'Lentejas 22', 'sadsad', 'img-1654880815517.png', 3, 1, 3, '01:01:00'),
(66, 'Prueba Final', 'asdasdsa', 'img-1654880937192.png', 1, 1, 3, '01:01:00'),
(67, 'Lentejas sadsad', 'asdasd', 'img-1654881092537.png', 3, 1, 3, '01:01:00'),
(68, 'Lentejas ', '1', 'img-1655028364235.jpeg', 3, 1, 3, '01:01:00'),
(69, 'Lentejas ', 'asdasd', 'img-1655028550875.jpeg', 83, 1, 3, '01:01:00'),
(70, 'Lentejas ', 'weqqweqwe', 'img-1655028808404.jpeg', 83, 1, 3, '01:01:00'),
(71, 'Borrar', 'q', 'img-1655029921659.jpeg', 83, 1, 3, '01:01:00'),
(72, 'Borrar', '1', 'img-1655029991011.jpeg', 1, 1, 3, '01:01:00'),
(73, 'Borrar', 'asdasd', 'img-1655030119214.jpeg', 3, 1, 3, '01:01:00'),
(74, 'Borrar', 'aaaaaaaa', 'img-1655031674757.jpeg', 3, 1, 3, '01:00:00');
...
INSERT INTO `users` (`id_usuari`, `nom_usuari`, `password`, `mail`, `validado`) VALUES
(1, 'Admin', '$2a$10$Qw14taNCpyjF1WgtG.S.Beblnpdi7PGZtkMcY/THJ4jk2RR74eYQ2', 'albertobermejo8@gmail.com', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `validar_user`
--

CREATE TABLE `validar_user` (
  `id_user` int(11) NOT NULL,
  `token` varchar(255) NOT NULL
) ;
...
--
-- Indices de la tabla `validar_user`
--
ALTER TABLE `validar_user`
  ADD PRIMARY KEY (`id_user`);
...
--
ALTER TABLE `receptes`
  MODIFY `id_recepta` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `recuperar_password`
--
ALTER TABLE `recuperar_password`
  ADD CONSTRAINT `FK_id_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_usuari`);

--
-- Filtros para la tabla `validar_user`
--
ALTER TABLE `validar_user`
  ADD CONSTRAINT `FK_user_id` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_usuari`);
COMMIT;
